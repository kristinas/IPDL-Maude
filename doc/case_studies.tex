...
\begin{abstract}
We present here the full proofs of select \ipdl case studies: Authenticated-To-Secure Channel: IND-CPA Encryption in Section \ref{sec:a2s_cpa}; Authenticated-To-Secure Channel: Diffie-Hellman Key Exchange in Section \ref{sec:a2s_dhke}; Oblivious Transfer: 1-Out-Of-2 Pre-Processing in Section \ref{sec:ot_pre}; and Multi-Party Coin Toss in Section \ref{sec:coin}.
\end{abstract}
